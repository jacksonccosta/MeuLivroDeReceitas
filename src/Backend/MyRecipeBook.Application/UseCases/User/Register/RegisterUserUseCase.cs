...
public class RegisterUserUseCase(IUserReadOnlyRepository userReadOnly, IUserWriteOnlyRepository userWriteOnly, IMapper mapper, IUnitOfWork unitOfWork, Encripter passwordEncrypter) : IRegisterUserUseCase
{
